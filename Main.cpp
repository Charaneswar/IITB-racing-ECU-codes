...
//====================================  led indications    ============================================================
//================Calling Function led indications===============
                led = led_indications(ignition_Sig.read(),gr_90_Sig.read());
                led1=led[0];
                led2=led[1];
...
starting_sequence(&flag_rtds, press_brakes_to_start, BPS_in, &rtds_Sig, &lvready, &led3,&flag_rtds,torque_avg,rpm_right_receive);
